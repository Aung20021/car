        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Add link to the Car Listing page -->
...
<x-nav-link :href="route('about')" :active="request()->routeIs('about')">
    ...
    <x-nav-link :href="route('appointments.page')" :active="request()->routeIs('appointments.page')">
        {{ __('Appointments') }}
    </x-nav-link>
...
@endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::check() && Auth::user()->role === 'user')
            <x-responsive-nav-link :href="route('appointments.page')" :active="request()->routeIs('appointments.page')">
                {{ __('Appointments') }}
            </x-responsive-nav-link>
